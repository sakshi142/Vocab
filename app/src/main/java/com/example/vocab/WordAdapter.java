...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView textname=layout.findViewById(R.id.textName01);
        TextView textadjective=layout.findViewById(R.id.textAdjective01);
        TextView textdescription=layout.findViewById(R.id.textDescription01);
